...
{
    echo "<meta http-equiv='content-type' content='text/html; charset=$g4[charset]'>";
    echo "<script language='JavaScript'>alert('data 디렉토리의 퍼미션을 707로 변경하여 주십시오.\\n\\n$> chmod 707 data \\n\\n그 다음 설치하여 주십시오.');</script>"; 
    exit;
}
...
{
    echo "<meta http-equiv='content-type' content='text/html; charset=$g4[charset]'>";
    echo "<script language='JavaScript'>alert('blog 디렉토리의 퍼미션을 707로 변경하여 주십시오.\\n\\n$> chmod 707 blog \\n\\n그 다음 설치하여 주십시오.');</script>"; 
    exit;
}
?>
<html>
...
<title>그누보드4 GBlog 설치 (1/2) - 라이센스(License)</title>
<style type="text/css">
<!--
.body {
	font-size: 12px;
